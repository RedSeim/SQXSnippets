...
public class SynthOverfittingRatio extends DatabankColumn {

    public SynthOverfittingRatio() {
        super("SynthOverfittingRatio",
        ...
        setWidth(110);
        setTooltip("Overfitting Ratio: Z-Score (con signo) del Net Profit original vs media/stdev en sintéticas (Custom Analysis).");
    }
